...
while {true} do {
	...
	_vitals ctrlSetStructuredText parseText format ["<t size='0.9'>%1 </t><img size='0.9' align='right' image='scripts\zsc\images\coins.paa'/>",[_money] call BIS_fnc_numberText];
